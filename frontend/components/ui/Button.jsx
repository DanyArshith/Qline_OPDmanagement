...
const VARIANTS = {
    ...
    secondary: 'bg-surface text-primary border border-border hover:bg-primary-soft active:scale-[0.98]',
    danger: 'bg-error text-white hover:bg-error/90 active:scale-[0.98]',
    ghost: 'bg-transparent text-text-secondary hover:bg-border active:scale-[0.98]',
}
